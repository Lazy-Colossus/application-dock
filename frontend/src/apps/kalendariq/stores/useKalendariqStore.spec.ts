...
import { useKalendariqStore } from "./useKalendariqStore";
...
describe("useKalendariqStore", () => {
  ...
  it("loads who I am", async () => {
    ...
    expect(getMock).toHaveBeenCalledWith("/kalendariq/me");
  ...
  it("loads one calendar", async () => {
    ...
    expect(getMock).toHaveBeenCalledWith("/kalendariq/calendars/cal-ab12cd34");
