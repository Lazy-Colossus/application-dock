"""Kalendariq API router.

Shared availability calendars. Unlike the other apps in this dock, Kalendariq's data is
...
guests vote, everyone else administers (see `kalendariq_service.is_admin`).
...
from app.schemas.kalendariq import (
    AddInviteeRequest,
    Calendar,
    CalendarSummary,
...
router = APIRouter(prefix="/api/kalendariq", tags=["kalendariq"])
...
share_router = APIRouter(prefix="/api/kalendariq/share", tags=["kalendariq-share"])
