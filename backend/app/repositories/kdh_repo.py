"""Filesystem persistence for KDH — one JSON file per calendar.
...
by the authenticated username; KDH's group shares one login, so a file is
...
from app.schemas.kdh import Calendar
