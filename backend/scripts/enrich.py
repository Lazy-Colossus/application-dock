...
def _load_document() -> None:
    """Read the collection once, up front, so a bad one stops the run.
...
def cmd_apply(args: argparse.Namespace) -> int:
    ...
    before = service.get_vocabulary()
    result = service.apply_enrichment(raw, write=args.write)
